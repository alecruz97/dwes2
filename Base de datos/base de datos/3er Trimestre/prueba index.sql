...
create index idx_lugares_denominacion on lugares (denominacion);
create index idx_lugares_tipo_id on lugares (tipo, id);
...
create index idx_ordenadores_modelo on ordenadores (modelo);
create index idx_ordenadores_marca_modelo on ordenadores (marca, modelo);
create index idx_ordenadores_lugar_id on ordenadores (lugar_id);
...
create index idx_ordenadores_marca on componentes (tipo);
create index idx_ordenadores_marca on componentes (id, tipo);
